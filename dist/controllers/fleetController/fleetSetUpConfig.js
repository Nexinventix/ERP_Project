    ...
    constructor() {
        ...
        this.assignVehicle = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const driver = yield fleet_1.Driver.findById(currentDriver);
        ...
        this.getAllVehicles = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const total = yield fleet_1.Vehicle.countDocuments();
        ...
        this.searchVehicles = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Get total count for pagination
                const total = yield fleet_1.Vehicle.countDocuments(searchFilter);
                const totalPages = Math.ceil(total / limitNum);
                // Perform the search with pagination
                const vehicles = yield fleet_1.Vehicle.find(searchFilter)
                    .skip(skip)
                    .limit(limitNum)
                    .populate('currentDriver')
                    .populate('maintenanceSchedule')
        ...
        this.debugVehicles = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const allVehicles = yield fleet_1.Vehicle.find().limit(5);
