...
class MaintenanceController {
    ...
    scheduleMaintenance(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { vehicleId, type, description, scheduledDate, mileage, cost = 0, parts = [], nextMaintenanceDate, nextMaintenanceMileage } = req.body;
                ...
                const existingMaintenance = yield fleet_1.Maintenance.findOne({
                    vehicle: vehicleId,
                    type,
                    status: 'scheduled',
    ...
    deleteMaintenance(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const maintenance = yield fleet_1.Maintenance.findByIdAndDelete(maintenanceId);
                if (!maintenance) {
