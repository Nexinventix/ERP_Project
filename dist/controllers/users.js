...
class UserController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const superAdmin = new users_1.default({
                    ...
                    department: Object.values(users_1.Department), // Super admins get all modules
                    permissions: Object.values(users_1.Permission),
                    isSuperAdmin: true
                });
                yield superAdmin.save();
                // Generate JWT Token
                const token = jsonwebtoken_1.default.sign({ id: superAdmin._id, isSuperAdmin: true }, config_1.SECRET_KEY, {
                    expiresIn: '7d'
                });
    ...
    createUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Validate department
                if (!isSuperAdmin && !Object.values(users_1.Department).includes(department)) {
                ...
                let userPermissions = [];
                if (isSuperAdmin) {
                    userPermissions = Object.values(users_1.Permission);
                }
                else if (permissions && Array.isArray(permissions)) {
                    // Validate provided permissions
                    const validPermissions = Object.values(users_1.Permission);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const superAdmin = new users_1.default({
                    ...
                    password: hashedPassword,
                    isSuperAdmin: true,
                    department: Object.values(users_1.Department),
                    permissions: Object.values(users_1.Permission), // Super admins get all permissions
                });
                yield superAdmin.save();
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const token = jsonwebtoken_1.default.sign({ id: user._id, isSuperAdmin: user.isSuperAdmin, isAdministrator: user.isAdministrator, department: user.department,
                    permissions: user.permissions }, config_1.SECRET_KEY, {
                    expiresIn: '7d',
                });
    ...
    getAllUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (department && Object.values(users_1.Department).includes(department)) {
                    filter.department = department;
                }
                const users = yield users_1.default.find(filter).select('-password -__v');
    ...
    updateUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (updates.department && !Object.values(users_1.Department).includes(updates.department)) {
                    return res.status(400).json({ message: "Invalid department" });
                }
                // Validate permissions if being updated
                if (updates.permissions) {
                    const validPermissions = Object.values(users_1.Permission);
                    const invalidPermissions = updates.permissions.filter((perm) => !validPermissions.includes(perm));
                    if (invalidPermissions.length > 0) {
                        return res.status(400).json({
                            message: `Invalid permissions: ${invalidPermissions.join(", ")}`,
                        });
                ...
                const user = yield users_1.default.findByIdAndUpdate(userId, updates, { new: true, runValidators: true }).select("-password");
                if (!user)
                    return res.status(404).json({ message: 'User not found' });
    ...
    getDepartmentPermissions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!req.user.isSuperAdmin && !req.user.isAdministrator) {
                    return res.status(403).json({ message: "Access denied" });
                ...
                const permissions = users_1.DEPARTMENT_DEFAULT_PERMISSIONS[department];
                res.status(200).json({
    ...
    getAllPermissions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const permissions = Object.values(users_1.Permission);
                const departmentPermissions = users_1.DEPARTMENT_DEFAULT_PERMISSIONS;
                res.status(200).json({
    ...
    resetUserPermissions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                user.permissions = users_1.DEPARTMENT_DEFAULT_PERMISSIONS[user.department] || [];
                yield user.save();
                res.json({
