...
const sendEmail = (to, subject, text, html, attachments) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(config_1.EMAIL_USER, config_1.EMAIL_PASS);
        const transporter = nodemailer_1.default.createTransport({
            service: 'gmail', // Change this based on your email provider
            auth: {
                user: config_1.EMAIL_USER, // Your email address
                pass: config_1.EMAIL_PASS, // Your email password or app password
            },
        });
        const mailOptions = {
